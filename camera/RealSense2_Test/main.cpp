...
int main(int argc, char * argv[]) try
{
    ...
    std::cout<<"\ncolor intrinsics: ";
    std::cout<<color_intrin.width<<"  "<<color_intrin.height<<"  "<<std::endl;
    std::cout<<color_intrin.ppx<<"  "<<color_intrin.ppy<<"  "<<std::endl;
    ...
    std::cout<<"\ndepth intrinsics: ";
    std::cout<<depth_intrin.width<<"  "<<depth_intrin.height<<"  "<<std::endl;
    std::cout<<depth_intrin.ppx<<"  "<<depth_intrin.ppy<<"  "<<std::endl;
