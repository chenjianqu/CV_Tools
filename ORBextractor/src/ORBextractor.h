...
public:
    ...
    [[nodiscard]] int inline GetLevels() const{
        return nlevels;}

    [[nodiscard]] float inline GetScaleFactor() const{
        return scaleFactor;}
...
protected:
    ...
    int nfeatures;//要检测的特征点的数量
    double scaleFactor;//金字塔尺度因子,1.2
    int nlevels;//金字塔的层数，8
    int iniThFAST;
    int minThFAST;
