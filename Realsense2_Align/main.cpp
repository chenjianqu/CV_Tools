...
{
    // Declare depth colorizer for pretty visualization of depth data,用于可视化深度数据
    rs2::colorizer color_map;
    // Aligning frames to color size，用于将深度数据对齐到RGB数据
    rs2::align depthToColorAlignment(RS2_STREAM_COLOR);
    // Declare threshold filter for work with dots in range，深度阈值滤波器，用于剔除深度值
    ...
    rs2::processing_block procBlock(
